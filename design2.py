...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.dataloglist, 1, 5, 1, 1)
        self.lcdNumber_2 = QtGui.QLCDNumber(self.centralwidget)
        self.lcdNumber_2.setObjectName(_fromUtf8("lcdNumber_2"))
        self.gridLayout.addWidget(self.lcdNumber_2, 1, 1, 2, 1)
        ...
        self.gridLayout.addWidget(self.mplwindow, 1, 2, 1, 1)
        self.startButton = QtGui.QPushButton(self.centralwidget)
        self.startButton.setObjectName(_fromUtf8("startButton"))
        self.gridLayout.addWidget(self.startButton, 3, 1, 1, 1)
        self.readingLabel = QtGui.QLabel(self.centralwidget)
        self.readingLabel.setText(_fromUtf8(""))
        self.readingLabel.setObjectName(_fromUtf8("readingLabel"))
        self.gridLayout.addWidget(self.readingLabel, 0, 1, 1, 2)
